...
>>   18 RETURN_VALUE"""
        ...
        edgelord = code[2][-4:-1].set_opacity(0)
        fn = (
            RoundedRectangle(
                width=4,
                height=1,
        ...
        char = code[1][-5:-1]
        char.set(color=ORANGE)
        self.play(
            code[2][:-4].animate.set_opacity(0.5),
            code[2][-1].animate.set_opacity(0.5),
            code[3].animate.set_opacity(1),
        )
        char_dup = code[3][-5:-1]
        char_dup_dup = code[3][-5:-1].copy().set(color=ORANGE)
        self.play(Transform(char, char_dup_dup))
        char_dup.set_opacity(0)
        me = ephem.next_to(ephem, UP)
        self.play(Transform(char, me))
        self.wait(2)
        char.set_opacity(0)
        self.play(
            code[4].animate.set_opacity(1),
            code[3][:-5].animate.set_opacity(0.5),
            code[3][-1].animate.set_opacity(0.5),
        )
        self.wait(2)
