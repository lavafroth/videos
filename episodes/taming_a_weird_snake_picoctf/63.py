...
>>   18 RETURN_VALUE"""
        ...
        _ord = Text('ord', font=codefont, font_size=32).move_to(fn)
        self.add(fn, _ord)
        _ord_call = Text('ord(   )', font=codefont, font_size=32)
        self.play(Transform(_ord, _ord_call[:3]), Transform(fn, _ord_call[3:]))
        self.wait(1)
